    ...
    <div class="container-fluid row">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td id="td_Rad_Val"><span id="span_Rad_Val_Ok" class="glyphicon glyphicon-ok">O</span><span id="span_Rad_Val_NO" class="glyphicon glyphicon-ok">X</span></td>
            </tr>
            <tr>
                ...
                <td id="td_Det_CO_Val"><span id="span_Det_CO_Val_Ok" class="glyphicon glyphicon-ok">O</span><span id="span_Det_CO_Val_NO" class="glyphicon glyphicon-ok">X</span></td>
            </tr>
            <tr>
                ...
                <td id="td_Tel_Val"><span id="span_Tel_Val_Ok" class="glyphicon glyphicon-ok">O</span><span id="span_Rad_GT_NO" class="glyphicon glyphicon-ok">X</span></td>
            </tr>
            <tr>
                ...
                <td id="td_GT_Val"><span id="span_Rad_GT_Ok" class="glyphicon glyphicon-ok">O</span><span id="span_Rad_GT_NO" class="glyphicon glyphicon-ok">X</span></td>
            </tr>
            <tr>
