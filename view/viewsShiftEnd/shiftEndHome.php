...
<div class="container-fluid">
    ...
    <div class="container-fluid row">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td>
                    <div id="lbl_GT">Gt info avisé</div>
                </td>
                <td id="td_GT_J" onclick="fn_Chk_GT_J()"><input type="checkbox" id="chk_GT_J"
                                                                style="visibility: hidden"></td>
                <td id="td_GT_N" onclick="fn_Chk_GT_N()"><input type="checkbox" id="chk_GT_N"
                                                                style="visibility: hidden"></td>
                <td><textarea style="resize: none" id="TXT_Area_GT" cols="100%" rows="3"></textarea></td>
                <td id="td_GT_Val"><span id="span_GT_Val_Ok" class="glyphicon glyphicon-ok" style="visibility: hidden">O</span><span
                            id="span_GT_Val_NO" class="glyphicon glyphicon-ok">X</span></td>
            </tr>
            <tr>
                <td>
